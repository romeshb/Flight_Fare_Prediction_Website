...
# to put this block inside button true statement(ln 79):
    ...
    df = pd.DataFrame([[Total_Stops,Journey_Month,Journey_Day,Dep_hour,Dep_minutes,Arrival_hour,Arrival_minutes,Duration_in_mins]],
                      columns=['Total_Stops','Journey_Month','Journey_Day','Dep_hour','Dep_minutes','Arrival_hour','Arrival_minutes','Duration_in_mins'])
    #print(df.iloc[[0]])
    ...
    # concate to a new dataframe
    # X = pd.concat([Total_Stops, Journey_Month, Journey_Day,
    #                Dep_hour, Dep_minutes, Arrival_hour,Arrival_minutes, Duration_in_mins,
    #                Airline_one_hot, Source_one_hot, Destination_one_hot, Weekday_one_hot], axis =1)
